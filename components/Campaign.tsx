  ...
  return (
    <div className=' w-[95vw] h-[100%] relative' id='campaign'>
        ...
        <div className=' w-[84%] justify-center items-center flex flex-col gap-4 absolute top-[5%] left-[8%]'>
          <p className=' text-5xl font-bold justify-items-start w-[100%]'>Introduce Our Campaign</p>
             ...
             />
              <div className=' w-[95%] flex flex-col mx-[2.5%] gap-4'>
                ...
                <div className=' flex flex-col gap-4'>
                  ...
                  <p className=' text-sm text-gray-500'>Help Donate for Cianjur Earthquake Victims by providing food, clothes, medicines, for their daily needs</p>
                </div>
                <div className=' flex gap-2'>
             ...
             />
              <div className=' w-[95%] flex flex-col mx-[2.5%] gap-4'>
                ...
                <div className=' flex flex-col gap-4'>
                  ...
                  <p className=' text-sm text-gray-500'>Campaign to provide quality books for children who are in need of proper education for their development</p>
                </div>
                <div className=' flex gap-2'>
                    <div className=' w-[90%] h-[14px] rounded-r-full rounded-l-full bg-[#EDEDED] flex flex-row'>
             ...
             />
              <div className=' w-[95%] flex flex-col mx-[2.5%] gap-4'>
                ...
                <div className=' flex flex-col gap-4'>
                  ...
                  <p className=' text-sm text-gray-500'>Help the Children of Cancer Warriors to meet their needs for care and treatment as well as possible to achieve recovery</p>
                </div>
                <div className=' flex gap-2'>
                    <div className=' w-[90%] h-[14px] rounded-r-full rounded-l-full bg-[#EDEDED] flex flex-row'>
