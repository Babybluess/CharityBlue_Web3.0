			...
			<div
				...
				<div className=" flex gap-5 w-[90%] items-center justify-center">
					<div className=" w-[35%] border-2 border-white hover:border-black hover:rounded-lg hover:bg-[#fcfcfc] hover:shadow-md ">
						<p className=" text-gray-500 text-center hover:text-black font-semibold">
							Donate with crypto
						</p>
					</div>
				...
				<div className=" flex gap-10 w-full justify-center ">
					<div className=" flex gap-2 font-semibold hover:underline hover:underline-offset-8 hover:decoration-[#0A7558] cursor-pointer">
						<Img src="/ethereum-cryptocurrency.svg" alt="" width={25} height={10} />
						<p>ETH</p>
					</div>
					<div className=" flex gap-2 font-semibold hover:underline hover:underline-offset-8 hover:decoration-[#0A7558] cursor-pointer">
						<Img src="/bitcoin-cryptocurrency.svg" alt="" width={25} height={10} />
						<p>BTC</p>
					</div>
					<div className=" flex gap-2 font-semibold hover:underline hover:underline-offset-8 hover:decoration-[#0A7558] cursor-pointer">
						<Img src="/tether-cryptocurrency.svg" alt="" width={25} height={10} />
						<p>USDT</p>
					</div>
					<div className=" flex gap-2 font-semibold hover:underline hover:underline-offset-8 hover:decoration-[#0A7558] cursor-pointer">
						<Img src="/binance-coin-cryptocurrency.svg" alt="" width={25} height={10} />
						<p>BNB</p>
					</div>
				</div>
