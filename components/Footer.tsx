    ...
    <div className=' w-[95vw] justify-center flex flex-col bg-gradient-to-r from-[#F2E6D3] to-[#D5E4DC] rounded-b-lg'>
        <div className=' h-[90%] w-[100%] px-[10%] flex justify-between items-center'>
            <div className=' w-[30%] flex flex-col gap-8 items-start h-[60%]'>
                ...
                <p className=' text-gray-500'>CharityBlue is a digital platform for collecting donations to be distributed to people in need.</p>
                <div className=' flex gap-8'>
                    <svg height="30" viewBox="0 0 48 48" width="30" xmlns="http://www.w3.org/2000/svg" className=' fill-gray-400'>
                        <path d="m0 0h48v48h-48z" fill="none"/><path d="m0 0h48v48h-48z" fill="none"/><path d="m44 6.1v35.8a.3.3 0 0 1 -.1.2 1.9 1.9 0 0 1 -1.8 1.8h-10.5v-15.4h4.9c.3 0 .3 0 .4-.3l.3-2.5c.1-1 .2-2 .4-3s0-.3-.2-.3h-5.8v-3.9c0-.3.1-.7.1-1a1.8 1.8 0 0 1 1.6-1.6l1.3-.2h3c.2 0 .2 0 .2-.2v-5.1c0-.1 0-.2-.2-.2h-4.6a7.2 7.2 0 0 0 -3.3.7 6 6 0 0 0 -3.5 3.1 7.3 7.3 0 0 0 -.8 3.6c-.1 1.5 0 3.1 0 4.7h-5.1c-.2 0-.2.1-.2.2v5.7c0 .2 0 .2.2.2h5.1v15.4a.3.3 0 0 0 -.1.2h-19.4a1.9 1.9 0 0 1 -1.8-1.8c-.1 0-.1-.1-.1-.2v-35.9c0-.1 0-.2.1-.2a1.9 1.9 0 0 1 1.8-1.8h36.2a1.9 1.9 0 0 1 1.8 1.8z"/>
                    </svg>
                    <svg height="32" viewBox="0 0 32 32" width="32" xmlns="http://www.w3.org/2000/svg" className=' fill-gray-400'>
            ...
            <div className=' w-[50%] flex gap-36 justify-items-end'>
                 <div className=' flex flex-col gap-5'>
                    ...
                    <ul className=' flex flex-col gap-4'>
                        ...
                        <li className=' text-gray-500'>Campaign</li>
                        <li className=' text-gray-500'>News</li>
                        <li className=' text-gray-500'>Volunteers</li>
                    </ul>
                </div>
                <div className=' flex flex-col gap-5'>
