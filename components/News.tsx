...
function News() {
  return (
    <div id='news' className=' w-[95vw] h-[100%] bg-[#FFFFFF] justify-center items-center flex flex-col gap-20'>
        <div className=' w-[90%] flex justify-between px-3'>
            <p className=' w-[20%] text-5xl font-semibold'>News and Updates</p>
            <div className='w-[45%] flex flex-col gap-5'>
                <p className=' text-gray-500'>Stay informed with the latest developments on charity campaigns to keep you engaged.</p>
                <div className='flex gap-2 border-2 border-[#0A7558] w-[30%] h-12 justify-center items-center rounded-2xl'>
                    <p className=' text-lg text-[#0A7558] font-semibold'><a href="">See All News</a></p>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="3.0" stroke="currentColor" className="w-4 h-4 text-[#0A7558] items-center">
             ...
             />
              <div className=' w-[100%] flex flex-col gap-4'>
                ...
                <div className=' flex flex-col gap-4'>
                  <p className=' text-xl font-bold'>Facts About COVID Kraken, The Latest Omicron Variant</p>
          ...
          <div className=' w-[300px] h-[400px] rounded-xl flex flex-col gap-3'>
             ...
             />
              <div className=' w-[100%] flex flex-col gap-4'>
                ...
                <div className=' flex flex-col gap-4'>
                  <p className=' text-xl font-bold'>The Shop Makes Donations For Cianjur Earthquake</p>
          ...
          <div className=' w-[300px] h-[400px] rounded-xl flex flex-col gap-3'>
             ...
             />
              <div className=' w-[100%] flex flex-col gap-4'>
                ...
                <div className=' flex flex-col gap-4'>
                  <p className=' text-xl font-bold'>Should Women Get Tetanus Shots Before Marriage?</p>
          ...
          <div className=' w-[300px] h-[400px] rounded-xl flex flex-col gap-3'>
             ...
             />
              <div className=' w-[100%] flex flex-col gap-4'>
                ...
                <div className=' flex flex-col gap-4'>
                  <p className=' text-xl font-bold'>Cases of Diabetes Mellitus in Children Soared Sharply!</p>
