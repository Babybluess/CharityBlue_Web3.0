...
function page() {
    ...
    const checkFullFill = () => {
        ...
        if(tittle  == '' || name == '' || age == '' || email == '' || phonenumber == '' || reason == '') {
            typeAgain()
        } else {
            confirm()
        }
    ...
    return (
        <div className="bg-[#1c1c24] flex justify-center items-center flex-col sm:p-10 p-4">
          ...
          <div className="flex justify-center items-center p-[16px] sm:min-w-[380px] bg-[#3a3a43] rounded-[10px]">
            <h1 className="font-epilogue font-bold sm:text-[25px] text-[18px] leading-[38px] text-white">Become a volunteer</h1>
          </div>
    
          <form className="w-full mt-[65px] flex flex-col gap-[30px]">
                <label className="flex-1 w-full flex flex-col">
                    <span className="font-epilogue font-medium text-[14px] leading-[22px] text-[#808191] mb-[10px]">Campaign Tittle *</span>
                    <input 
                        id='campaignTittle'
                        required
                        type="text"
                ...
                <div className=' flex flex-wrap gap-[40px]'>
                    ...
                    <label className="flex-1 w-full flex flex-col">
                        <span className="font-epilogue font-medium text-[14px] leading-[22px] text-[#808191] mb-[10px]">Age *</span>
                        <input 
                            id='age'
                            required
                            type="number"
            ...
            <div className="flex flex-wrap gap-[40px]">
                <label className="flex-1 w-full flex flex-col">
                    <span className="font-epilogue font-medium text-[14px] leading-[22px] text-[#808191] mb-[10px]">Email *</span>
                    <input 
                        id='email'
                        required
                        type="email"
                ...
                <label className="flex-1 w-full flex flex-col">
                    <span className="font-epilogue font-medium text-[14px] leading-[22px] text-[#808191] mb-[10px]">Phone number *</span>
                    <input 
                        id='phoneNumber'
                        required
                        type="tel"
            ...
            <label className="flex-1 w-full flex flex-col">
                <span className="font-epilogue font-medium text-[14px] leading-[22px] text-[#808191] mb-[10px]">Why to become a volunteer *</span>
                <textarea 
                    id='reason'
                    required
                    rows={10}
